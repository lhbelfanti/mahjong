...
{
	public class DoubleHTileValidator : TileValidator
	{
		public DoubleHTileValidator(int[,,] tiles, EditorTile et) : base(tiles, et)
		{
		}
		...
		public override bool Validate()
		{
			...
			string msg2 = $"Error 2: There is already another tile in the position {(_et.x + 1).ToString()}x{_et.y.ToString()}.\n";
